...
1078,
1081)
pop_genl <- gl.drop.ind(filtered_genl, c(drop_inds, drop_others), recalc = TRUE,
	mono.rm = TRUE)
```
...
"R11_Ham",
"R03_ere")
pop_genl_ere_noR3 <- gl.drop.pop(pop_genl, drop_pops, recalc = TRUE,
	mono.rm = TRUE)
```
...
"R11_Ham",
"R12_Ham")
pop_genl_Ham_noR11R12 <- gl.drop.pop(pop_genl, drop_pops, recalc = TRUE,
	mono.rm = TRUE)
```
