...
plot_pca <- function(pca, numsnps, colours, points, x = 1, y = 2) {
	...
	pca_scores <- pca$scores[order(rownames(pca$scores)), ]
	# plot
...
```
Run the plotting for four groups
```{r}
...
```{r}
num_snps <- nLoc(filtered_genl)
plot_pca(pca, num_snps, colours[2: 3], points[2: 3], x = 1, y = 2)
plot_pca(pca, num_snps, colours[2: 3], points[2: 3], x = 1, y = 3)
plot_pca(pca, num_snps, colours[2: 3], points[2: 3], x = 1, y = 4)
plot_pca(pca, num_snps, colours[2: 3], points[2: 3], x = 2, y = 3)
plot_pca(pca, num_snps, colours[2: 3], points[2: 3], x = 2, y = 4)
plot_pca(pca, num_snps, colours[2: 3], points[2: 3], x = 3, y = 4)
```
Plot a legend
```{r}
